...
<head>
    ...
    <title>DH AUTOCARE - Stock List</title>
</head>
<body>
        ...
        <header class="page-header">
            <div class="header-content">
                <div class="header-left">
                    ...
                    <p class="page-subtitle">View and manage current stock levels and inventory items.</p>
                </div>
            </div>
        </header>
            ...
            <div class="row mb-3 align-items-end gx-2">
                ...
                <div class="col-lg-6 col-md-3 col-12 mb-2 d-flex align-items-end justify-content-end">
                    <ul class="nav nav-pills mb-0" id="creditorTabs">
                        ...
                        <li>
                            <button class="btn btn-sm px-3" id="stock-tab" type="button" data-sort="stock">Stock Level<span class="sort-indicator"></span></button>
                        </li>
                    </ul>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    function loadStockList(params) {
        ...
        $.get('stock_list_data.php', params, function(data) {
    ...
    // Live search with debounce (delegated; search input is rendered inside content)
    let searchTimeout;
    $(document).on('input', '#search', function() {
        clearTimeout(searchTimeout);
        searchTimeout = setTimeout(function(){ reloadStockList(1); }, 300);
    });
    // Tab click
    ...
    window.printStockList = function() {
        ...
        var printUrl = 'stock_list_print.php';
        if (queryString) {
