            ...
            <div class="row mb-3 align-items-end gx-2">
                ...
                <div class="col-lg-6 col-md-6 col-12 mb-2 d-flex align-items-end justify-content-end">
                    <ul class="nav nav-pills mb-0" id="creditorTabs">
                        <li>
                            <button class="btn active-tab btn-sm px-3" id="product-tab" type="button" data-sort="name">Product Name</button>
                        </li>
                        <li>
                            <button class="btn btn-sm px-3" id="price-tab" type="button" data-sort="price">Price</button>
                        </li>
                    </ul>
                </div>
            </div>
